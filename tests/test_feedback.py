...
- append_feedback writes valid markdown
...
def test_append_feedback_creates_file_with_header(gaps_file: Path):
...
def test_append_feedback_second_entry_does_not_duplicate_header(gaps_file: Path):
    feedback.append_feedback(
        thread_ts="1700.123",
        user_id="U1",
        user_name="Thomas",
...
def test_append_feedback_handles_missing_user_name(gaps_file: Path):
    feedback.append_feedback(
        thread_ts="1700.123",
        user_id="U1",
        user_name=None,
